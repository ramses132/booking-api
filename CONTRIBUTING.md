...
Contributions to booking-api are very welcome! Best have a look at the open [issues](https://github.com/ramses132/booking-api)
and open a [GitHub pull request](https://github.com/ramses132/booking-api/compare). See instructions below how to setup development
...
To work on booking-api you first need to clone

```bash
git clone https://github.com/ramses132/booking-api.git
cd booking-api
```
...
echo UID=$UID > .env
# open shell
docker-compose run --rm booking-api bash
```
