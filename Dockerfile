...
&& mkdir -p /app \
&& useradd -u 901 -r booking-api --create-home \
...
&& chown -R booking-api:root /home/booking-api \
&& chmod -R 770 /home/booking-api
...
ENV HOME=/home/booking-api

ENV PYTHONUNBUFFERED=1
ENV DJANGO_SETTINGS_MODULE booking-api.settings
ENV APP_HOME=/app
